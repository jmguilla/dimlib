...
public class User extends Model implements Identity {
  ...
  public static User findByUserIdAndProviderId(String uid, String pid) {
    return find.where().ieq("userId", uid).ieq("providerId", pid).findUnique();
  }

  public static User findByEmailAndProvider(String email,
      String pid) {
    return find.where().ieq("email", email).ieq("providerId", pid).findUnique();
  }
  ...
  public static String buildEmailColonProviderId(String email, String providerId) {
